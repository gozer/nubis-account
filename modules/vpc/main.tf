...
module "jumphost" {
  source = "github.com/nubisproject/nubis-jumphost//nubis/terraform?ref=v2.4.3"
...
module "fluent-collector" {
  source = "github.com/nubisproject/nubis-fluent-collector//nubis/terraform?ref=v2.4.3"
...
module "monitoring" {
  source = "github.com/nubisproject/nubis-prometheus//nubis/terraform?ref=v2.4.3"
...
module "sso" {
  source = "github.com/nubisproject/nubis-sso//nubis/terraform?ref=v2.4.3"
...
module "consul" {
  source = "github.com/nubisproject/nubis-consul//nubis/terraform?ref=v2.4.3"
...
module "ci" {
  source = "github.com/nubisproject/nubis-ci//nubis/terraform?ref=v2.4.3"
...
module "vpn" {
  source = "github.com/nubisproject/nubis-terraform-vpn?ref=v2.4.3"
...
module "kubnernetes" {
  source = "github.com/nubisproject/nubis-kubernetes//nubis/terraform?ref=v2.4.3"
